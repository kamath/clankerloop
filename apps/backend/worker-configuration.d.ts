/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 310ec3dade6c0d245c18e9f89cc7ef4f)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_BACKEND_API_KEY: string;
		...
		clankerrank: R2Bucket;
		PROBLEM_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/index").ProblemGenerationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_API_KEY" | "DATABASE_URL" | "DAYTONA_API_KEY" | "BRAINTRUST_API_KEY" | "PROJECT_NAME" | "NEXT_PUBLIC_BACKEND_URL" | "NEXT_PUBLIC_BACKEND_API_KEY" | "WORKOS_API_KEY" | "WORKOS_CLIENT_ID" | "WORKOS_COOKIE_PASSWORD" | "NEXT_PUBLIC_WORKOS_REDIRECT_URI" | "POSTHOG_API_KEY" | "R2_BASE_URL">> {}
}
